...
Il metodo anti-rappresentativo può agevolare questa trasformazione sociale in quanto rifiuta pratiche discorsive che creano una narrazione vittima di preconcetti o preformazioni della materia. Rifiuta la determinazione preconcettualizzata e introduce l’intra-azione performativa della materia.
...
Byung-chul Han descrive efficacemente il sistema infocratico all’interno del quale ci troviamo. Il nichilismo politico è una questione storica che progredisce in modo procedurale, concatenando un evento all’altro anche se questi sembrano completamente distanti.

Analizzare i rapporti causali storici è sicuramente un punto fondamentale della contemporaneità. In questo testo, però, non voglio realizzare un’analisi statistica supportata da dati scientifici, il mio obiettivo, piuttosto, è quello di fornire un punto di vista empirico/esperienziale di una soggettività appartenente alla generazione Y, la quale ha creato una frattura epistemologica rispetto alle generazioni precedenti.
...
L’ipersoggettivizzazione dell’individuo convinto del potere della propria singola narrazione danneggia inevitabilmente anche le dinamiche di coesione collettiva. Il confronto non si basa più su argomentazioni in grado di mutare l’opinione del singolo, ma sul sostenere le proprie tesi nella convinzione che le antitesi esistano solo per mera estensione del concetto di opposizione. La fallace idea democratica di un uguale peso ideologico genera un'indeterminazione sociale che ci allontana, introiettati come siamo in un mondo falsamente immutabile. È possibile allora lesionare questa stasi accogliendo la contaminazione e l'ascolto per trasformare il vuoto indeterminato in una potentia affermativa che ricostruisca il collettivo? Abbandonando la verticalità delle risposte certe, la via risiede in un processo trasformativo che dal singolo si apra alla comunità.
...
L’indeterminazione fisica che viviamo attualmente ha diverse dimensioni e, con l’avanzare della tecnologia, amplia le possibilità che il nostro immaginario ci offriva negli anni passati. La teoria cyborg nel 2025 sembra meno utopica. Viviamo in simbiosi con la tecnologia: essa è diventata a tutti gli effetti una vera e propria estensione corporea, assumendo forme prostetiche sia corporee che digitali. Da quest’ultime veniamo monitorati sia in termini di utilizzi temporali degli stessi, sia in termini fisici attraverso contapassi e app che monitorano la nostra fisicità e/o l’apporto calorico delle nostre diete. Questo fa sì che l’indeterminazione della persona assuma una forma che essa stessa decide.
...
Partendo dalla potenzialità ribollente del vuoto, "Compost" punta a fissare delle pratiche teorico/laboratoriali che vengano stimolate da questa potenzialità. Il vuoto, e le possibilità che esso offre, fa sì che la materialità non sia relegata allo status Newtoniano di codifica precostituita di un oggetto. La materialità è anti-rappresentativa ed indeterminata, e noi vogliamo proporre un’epistemologia basata su questa nuova linea ontologica della materia.
